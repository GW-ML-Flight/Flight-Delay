...
::: columns
::: {.column width="50%"}
![Bucket Confusion Matrix](images/confusion_matrix.png){#fig-confusion width="100%"}
:::

::: {.column width="50%"}
![Bucket Results](images/buckets-results.png){#fig-buckets width="100%"}
:::
:::
...
-   Wrote and edited various sections of the report; setup the Quarto site.
:::
