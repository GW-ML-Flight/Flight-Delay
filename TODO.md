...
- [X] Tail-number features from the flight table: prior delay of the same TAIL_NUM, plus time since the aircraft’s previous flight and previous arrival delay if available. This is a strong proxy for aircraft knock-on delay.
